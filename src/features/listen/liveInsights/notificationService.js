...
const NotificationType = {
    ...
    SYSTEM: 'system'             // System events (model changes, etc.)
};
...
class NotificationService extends EventEmitter {
    ...
    /**
     * Notify about system events (e.g., model changes)
     * @param {Object} event - System event details
     */
    notifySystemEvent(event) {
        ...
        const notification = this._createNotification(
            ...
            event.title || '⚙️ System Event',
            event.message,
            event.priority || NotificationPriority.LOW,
            event.metadata || {}
        );
