...
async function checkAndRunMigration(firebaseUser) {
    ...
    try {
        // Fix CRITICAL BUG-C6: Check if Firebase is initialized before migration
        ...
        // Fix CRITICAL BUG-C7: Verify Phase 1 success before continuing
        ...
        // Fix CRITICAL BUG-C7 & C8: Verify Phase 2 success before marking complete
        ...
        // Fix CRITICAL BUG-C8: Only mark migration complete after BOTH phases succeed
        // This line is now executed only if both Phase 1 and Phase 2 completed without throwing
        ...
        console.error('[Migration] Migration NOT marked as complete due to error - user can retry on next login');
        // Fix CRITICAL BUG-C8: Do not mark migration complete if error occurred
        // setMigrationComplete is NOT called in catch block, allowing retry
    }
}
