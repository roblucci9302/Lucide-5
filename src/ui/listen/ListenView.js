...
import './SpeakerManager.js'; // Speaker Diarization
...
.hljs-tag {
    ...
    adjustWindowHeight() {
        ...
        this.updateComplete
            .then(() => {
                ...
                // FIX: Utiliser la vraie hauteur du contenu interne pour ResponseView
                // (sinon on obtient la hauteur limitée par max-height)
                let contentHeight;
                if (this.viewMode === 'suggestions' && typeof activeContent.getContentHeight === 'function') {
                    contentHeight = activeContent.getContentHeight();
                } else {
                ...
                // Augmenté de 700 à 900px pour permettre d'afficher toutes les suggestions
                const targetHeight = Math.min(900, idealHeight);
    ...
    handleSuggestionsUpdated(event) {
        // Handle suggestions update from ResponseView
        console.log('[ListenView] Suggestions updated, adjusting window height');
        this.adjustWindowHeightThrottled();
    }
    ...
    render() {
        ...
        return html`
            <div class="assistant-container">
                ...
                <response-view
                    .visible=${this.viewMode === 'suggestions'}                    @suggestions-updated=${this.handleSuggestionsUpdated}                ></response-view>
