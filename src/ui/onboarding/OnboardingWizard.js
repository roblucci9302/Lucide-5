...
export class OnboardingWizard extends LitElement {
    ...
    async skipOnboarding() {
        try {
            ...
            // Use default profile (lucide_assistant) when skipping
            const data = {
                selectedProfile: 'lucide_assistant',
                preferences: {}
            };
            ...
            if (window.showToast) {
                window.showToast('Bienvenue dans Lucide !', 'success', 2000);
            }
            ...
            console.error('[OnboardingWizard] Error skipping onboarding:', error);
            if (window.showToast) {
                    ...
                    <div class="step-content">
                        ...
                        <div class="actions">
                            ${this.currentStep === 0 ? html`
                                <button class="btn btn-skip" @click=${this.skipOnboarding}>
