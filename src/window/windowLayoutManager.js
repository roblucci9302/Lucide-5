...
class WindowLayoutManager {
    /**
     * @param {Map<string, BrowserWindow>} windowPool - Map des fenêtres à gérer
     */
    ...
    // Remplace l'ancienne fonction getTargetBoundsForFeatureWindows
    ...
    calculateStepMovePosition(header, direction) {
        if (!header) return null;
        const currentBounds = header.getBounds();
        const stepSize = 80; // Intervalle de déplacement
