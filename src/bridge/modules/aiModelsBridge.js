...
module.exports = {
    initialize() {
        ...
        // PHASE 3: Auto-selection controls
        ipcMain.handle('model:get-auto-selection-enabled', () => modelStateService.isAutoSelectionEnabled());
        ipcMain.handle('model:set-auto-selection-enabled', (e, enabled) => {
            modelStateService.setAutoSelectionEnabled(enabled);
